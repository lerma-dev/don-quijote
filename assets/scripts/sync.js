...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.addEventListener("click", async (e) => {
        ...
        // Resaltar visualmente el capítulo activo en el mini player
        document.querySelectorAll("#chapter-container button.active").forEach(b => b.classList.remove("active"));
